...
Drupal.behaviors.rooms_availability = {
  attach: function(context) {
    ...
    load_calendar(currentMonth, currentYear, firstDay);
    
    $('#edville-calendar-back').on('click', function(e) {
      e.preventDefault();
      if (currentMonth == 0) {
        currentMonth = 11;
    ...
    $('#edville-calendar-forward').on('click', function(e) {
      e.preventDefault();
      if (currentMonth == 11) {
        currentMonth = 0;
        currentYear = currentYear + 1;
...
function load_calendar(currentMonth, currentYear, firstDay) {
