(function ($) {alert('kilaku');
// define object
// Drupal.EdvilleRoomsAvailability = Drupal.EdvilleRoomsAvailability || {};
// Drupal.EdvilleRoomsAvailability.Modal = Drupal.EdvilleRoomsAvailability.Modal || {};

// Drupal.behaviors.edville_rooms_availability = {
...
//           $(value[0]).fullCalendar('refetchEvents');
//         },
//         events: Drupal.settings.basePath + '?q=rooms/units/unit/' + Drupal.settings.EdvilleRoomsAvailability.roomID + '/availability/json/' + value[2] + '/' + phpmonth,
...
//           Drupal.EdvilleRoomsAvailability.Modal(view, calEvent.id, sd, ed);
//         },
...
//           ed = end.unix();
//           // Open the modal for edit
//           Drupal.EdvilleRoomsAvailability.Modal(this, -2, sd, ed);
...
// */
// Drupal.EdvilleRoomsAvailability.Modal = function(element, eid, sd, ed) {
...
//     url : base + Drupal.settings.EdvilleRoomsAvailability.roomID + '/event/' + eid + '/' + sd + '/' + ed,
//     event : 'getResponse',
