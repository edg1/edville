  ...
  Drupal.behaviors.ColorizedMap = {
    attach: function (context, settings) {
      ...
      if (typeof settings['colorized_gmap'] == 'undefined') {
        ...
        if (settings['colorized_gmap']['additional_settings']['marker_settings']['info_window']) {
          var infowindowContent = settings['colorized_gmap']['additional_settings']['marker_settings']['info_window']['value'];
        }
