...
// *//*
function booking_theme_js_alter(&$javascript) {
    $script = drupal_get_path('theme', 'booking_theme') .'/scripts/custom.js';
  $javascript[$script]['group'] = 10000;
  $javascript[$script]['weight'] = 10000;
}*/