Druproid Notifications Overview
===========================

The Druproid Notifications module provides the feature set to send out druproid
notifications to iOS (iPhone/iPad) and Android devices using Apple's
Druproid Notification Service (APNS) as well as Google's Android Cloud to Device
...
send out druproid notifications to any mobile device for free.



Druproid Notification Settings
==========================
Navigate to /admin/config/services/druproid_notifications/configure to configure the
druproid notification settings for APNS, GCM or C2DM.



Mass-Druproid notification
======================
Navigate to admin/config/services/druproid_notifications/message. On this page,
you can compose a druproid notification to send out to all registered recipients.
Enter your message, select the recipient groups (iOS, Android or both) and
click on "Send Druproid Message".
...
---Register
URL: http://my-drupal-installation/services_module_endpoint/druproid_notifications
Method: "POST"
Payload: token={token}&type={type}

---Unregister
http://my-drupal-installation/services_module_endpoint/druproid_notifications/{token}
Method: "DELETE"
Payload:
