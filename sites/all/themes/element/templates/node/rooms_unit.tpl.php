  ...
  <div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <div class="unit-detail-content content"<?php print $content_attributes; ?>>
      ...
      <ul class="room-features">
        ...
        <li><img src="/<?php print $theme_path . '/images/icons/bed.png'; ?>" />
          <span>
            <?php
            switch (intval($unit_object->data['bed_arrangement']['singles'])) {
              case 2:
                  print t('Sofa bed');
                  break;
                case 0:
                  ...
                  break;
                default:
                  print $unit_object->data['bed_arrangement']['singles'] . t(' singles');
              }
            ?>
          </span>
        </li>
