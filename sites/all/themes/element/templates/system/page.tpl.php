...
<div id="container">
      ...
      <div class="container">
        ...
        <?php if (!empty($primary_nav) || !empty($secondary_nav) || !empty($page['navigation'])): ?>
          <div class="navbar-collapse collapse">    
            <?php if (!empty($page['menu_extra'])): ?>
              <?php print render($page['menu_extra']); ?>
            <?php endif; ?>    
  ...
  <?php if (!empty($page['content_top_full'])): ?>
  ...
  <?php if (!empty($page['content_bottom_full'])): ?>
  <div class="content-bottom-full">  
    <?php print render($page['content_bottom_full']); ?>  
  </div>
  <?php endif; ?>
  <!-- Content bottom fullwidth -->
  <?php if (!empty($page['last_row'])): ?>
  <div class="last-row">  
    <?php print render($page['last_row']); ?>  
  </div>
  <?php endif; ?>
  <footer>
    <div class="up-footer">
